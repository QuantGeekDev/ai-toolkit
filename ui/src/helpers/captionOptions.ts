...
export interface CaptionOption {
  ...
  label: string;
  group: CaptionGroup;
  executionTarget?: 'local_gpu' | 'cloud';
  provider?: string;
...
export const captionerTypes: CaptionOption[] = [
  {
    ...
    defaults: {
      ...
      'config.process[0].caption.request_timeout_seconds': [120, undefined],
      'config.process[0].caption.max_attempts': [4, undefined],
    ...
    additionalSections: ['caption.caption_prompt'],
    name_or_path_options: [{ value: 'gemini-3.1-pro-preview', label: 'gemini-3.1-pro-preview' }],
  },
  {
